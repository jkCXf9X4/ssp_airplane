...
4. **Clarify the scenario workflow** – The scenario workflow section now walks through architecture export, FMU build, SSP packaging, simulation, and testing with updated commands and context on outputs.
5. **Refresh topic-specific docs** – `docs/autopilot.md` and `docs/results_and_evaluation.md` reference the new modules and highlight how to reuse results, generate waypoint strings, and produce plots without re-running ssp4sim.
