...
from scripts.utils.sysml_compat import architecture_connections, architecture_port_definitions  # type: ignore  # noqa: E402
...
def test_parser_collects_parts_and_ports():
    ...
    mission_computer = architecture.parts["MissionComputer"]
    ...
    pilot_command = architecture_port_definitions(architecture)["PilotCommand"]
