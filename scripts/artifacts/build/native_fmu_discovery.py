...
from scripts.common.paths import ARCHITECTURE_DIR, COMPOSITION_NAME, MODELS_DIR
from scripts.artifacts.build.native_fmu_project import DEFAULT_BUILD_ROOT, NativeFmuProject
