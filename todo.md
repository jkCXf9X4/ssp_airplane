[x] extract the MODEL_CLASS_MAP from the architecture instead of hardcoding it into the scripts (see `scripts/utils/sysml_helpers.py` + `fmi_helpers.py`)
[x] create a fmi utils and lift out common code from the scripts (`scripts/utils/fmi_helpers.py`)
